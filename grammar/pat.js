...
module.exports = {
   ...
   * `pat_apply` can be a variable, even though it's not valid Synquid.
   * While the static prec 'pat-name' covers this at generation time, Synquid's ambiguity requires us to use a runtime
